...
const WorkCard: React.FC<WorkCardProps> = ({ work, onRead, onEdit }) => {
  ...
  return (
    <View style={[styles.container, { borderLeftColor: work.categoryColor }]}>
      <View style={styles.content}>
            ...
            <View style={styles.metaContainer}>
              ...
              <View
                style={[
                  styles.categoryTag,
                  {
                    backgroundColor: getCategoryBackgroundColor(work.categoryColor),
                  },
                ]}
              >
                <Text style={[styles.categoryText, { color: work.categoryColor }]}>
                  {work.category}
                </Text>
              </View>
            </View>
        ...
        <View style={styles.footer}>
          ...
          <View style={styles.buttonContainer}>
            ...
            <TouchableOpacity
              style={[styles.editButton, { backgroundColor: work.categoryColor }]}
