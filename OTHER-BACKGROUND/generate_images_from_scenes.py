...
API_KEY = "sk-gyxfthqwngqqnfaghtrnnhtrhdumjjqlkgmipqhywjpoilho"  # 
MODEL = "Qwen/Qwen-Image"      # 可选: Qwen/Qwen-Image, Kwai-Kolors/Kolors 等
OUTPUT_DIR = "generated_images"
IMAGE_SIZE = "1024x1024"       # 推荐分辨率，可改为 "1472x1140" (4:3)
# ===================================
